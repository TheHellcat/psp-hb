...
{
  pspDebugScreenSetBackColor(0x00002200);
  pspDebugScreenSetTextColor(0x00FFFFFF);
  pspDebugScreenClear();
  pspDebugScreenSetXY(0, 30);
  printf( "\n----------------------------------- based on Recovery Flasher -----\n" );
  ...
  printf( "  **   BHOP'D - Bang Head on PSP, DONE :-D   **\n  Super Easy Uber N00ble Prove CFW Installer\n" );
  pspDebugScreenSetTextColor(0x00FFFFFF);
  printf( "------------- for Lampworker and his helpers ----- by HELLCAT -----\n" );
  printf( "\n" );
