...
//PspType = 3000;
  ...
  if( ( PspType == 2500 ) || ( PspType == 3000 ) )
  {
    ...
    */
    printf( "  So, as sad as it is, all I can do to say bye-bye.... :-(\n\n\n\n" );
  ...
  while( r != 99 )
  {
    if( (r == 98) || (r == 96) )
    {
      ...
      printf( " BHOP'D - Bang Head On PSP - DONE!\n" );
...
/*      if( (PspType != 2500) && (PspType != 3000) )
    ...
    // cut down menu:
    hcMiscMenuAddEntry( "Install CFW 5.00-M33", 10, "  Hitting this option will install a fresh'n'clean CFW to your PSP\n  Version installed is: 5.00-M33-6");
    hcRfHelperBatGetSerial( s+128 );
    r = *(u32*)(s+128);
    if( r != 0xFFFFFFFF )
    {
    ...
    hcMiscMenuAddEntry( " ", -1, " " );
    hcMiscMenuAddEntry( "EXIT", 99, "  get out and do nothing" );
