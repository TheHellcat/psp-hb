...
int main(int argc, char *argv[])
{
  ...
  printf( "\n\n\n" );
  printf( "  ATTENTION:\n\n" );
  printf( "  This is a CFW-plugin-enabled build of Recovery-Flasher intended\n" );
  printf( "  for beeing able to make screenshots for\n  tutorials/guides/articles/whatever.\n\n" );
  printf( "  Do *NOT* use this build to perform actual flashing as chances\n" );
  printf( "  for your PSP to brick are very high due to interference of\n" );
  printf( "  plugins or not running in updater mode!\n\n\n" );
  printf( "  Press any button to proceed....\n" );
  printf( "\n\n\n  * This build is exclusively for use by:\n    WoodstockimWeb @ gulli:board" );
  hcMiscWaitForAnyButton();
  ClearScreen();
