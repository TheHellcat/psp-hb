...
int main(int argc, char *argv[])
{
  ...
  while( r != 99 )
  {
    if( r == 98 )
    {
      ...
      hcMiscMenuAddEntry( "Flash new 5.00-M33-3", 13, "  This option will install a new and fresh 5.00-M33-3 to your PSP.\n  For recovering semi-bricks or up-/downgrading your CFW.");
    ...
    if( r == 13 ) { TargetFW = 500; DoCFWInstall( PspType, sPspType ); r = 98; }
