...
/*
  u32 kregs[0x400];
  int c;
  *(u32*)(0xBC100050) |= (1<<7); // enable KIRK
  for( i=0xBDE00000, c=0; i<0xBDE01000; i+=4, c++)
  {
  	//printf("0x%08X: 0x%08X\n", i, *(u32*)(i) );
  	kregs[c]=*(u32*)(i);
  }
  hcWriteFile( "ms0:/kirkregs.bin", kregs, sizeof(kregs) );
  //hcWriteFile( "ms0:/88400000.bin", (void*)0x88400000, 0x00400000 );
  void* vadr;
  int vsz;
  //sceKernelVolatileMemLock( 0, &vadr, &vsz );
  //printf( "\n\n********************\nvolatile mem: 0x%08X - size: 0x%08X bytes\n**********\n\n", (int)vadr, vsz );
  //r = sceKernelSetDdrMemoryProtection( (void*)0x08400000, 4*1024*1024, 0xF );
  //printf( "\n\n********************\n sceKernelSetDdrMemoryProtection = 0x%08X \n**********\n\n", r );
  *(u32*)(0xbc000000) = 0xFFFFFFFF;
  *(u32*)(0xbc000004) = 0xFFFFFFFF;
  *(u32*)(0xbc000008) = 0xFFFFFFFF;
  *(u32*)(0xbc00000C) = 0xFFFFFFFF;
  printf("**********\n");
  *(u32*)(0xbc000010) = 0xFFFFFFFF;
  *(u32*)(0xbc000014) = 0xFFFFFFFF;
  *(u32*)(0xbc000018) = 0xFFFFFFFF;
  *(u32*)(0xbc00001C) = 0xFFFFFFFF;
  printf("**********\n");
  sceKernelDelayThread(20000000);
  hcWriteFile( "ms0:/B0000000.bin", (void*)0xB0000000, 1 * 1024 * 1024 );
  hcWriteFile( "ms0:/B1800000.bin", (void*)0xB1800000, 1 * 1024 * 1024 );
  hcWriteFile( "ms0:/BFC00000.bin", (void*)0xBFC00000, 1 * 1024 * 1024 );
  //hcWriteFile( "ms0:/BFD00000.bin", (void*)0xBFD00000, 0x1000 );
  hcWriteFile( "ms0:/BFE00000.bin", (void*)0xBFE00000, 1 * 1024 * 1024 );
  hcWriteFile( "ms0:/BFF00000.bin", (void*)0xBFF00000, 1 * 1024 * 1024 );
  //hcWriteFile( "ms0:/BFEFF000.bin", (void*)0xBFEFF000, 0x1000 );
  //hcWriteFile( "ms0:/20000000.bin", (void*)0x20000000, 0x1000 );
*/
  RunningAsDDC7 = 0;
