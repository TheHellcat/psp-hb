...
PSP_MODULE_INFO("PandoraForKernel3xx", 0, 4, 2);
...
void ClearScreen(void)
{
  ...
  pspDebugScreenClear();
  printf("*** Pandora Installer for 3.xx+ Kernels ***   -- Rev4b --\n");
  printf("*******************************************\n\n");
...
void ExtractUpdaterSepcialPRX2( void )
{
  ...
  for( i=0; i<dpsp_l; i+=4 )
  {
    ...
    if( m == tag )
    {
      ...
      if( strcmp( (char*)(modptr[0]+0x0A), "sceLFatFs_Updater_Driver" ) == 0 )
      {
        WriteFile( "ms0:/TM/DC7/kd/lfatfs_updater.prx", modptr[0], modlen[0] );
      }
      if( strcmp( (char*)(modptr[0]+0x0A), "sceNAND_Updater_Driver" ) == 0 )
      {
        WriteFile( "ms0:/TM/DC7/kd/emc_sm_updater.prx", modptr[0], modlen[0] );
      }
    }
  }
  ...
  for( i=0; i<dpsp_l; i+=4 )
  {
    ...
    if( m == tag )
    {
      ...
      if( strcmp( (char*)(modptr[0]+0x0A), "sceLflashFatfmtUpdater" ) == 0 )
      {
        WriteFile( "ms0:/TM/DC7/kd/lflash_fatfmt_updater.prx", modptr[0], modlen[0] );
      }
    }
  }
...
void RunDDC6PandoraInstall( void )
{
  ...
  char* AdditionalDDCFiles[] = { "DDC6_bg.bmp",             "/vsh/resource/bg.bmp",
  	                             ...
  	                             "DDC7_pspbtdnf.bin",       "/kd/pspbtdnf.bin",
  	                             "DDC7_pspbtdnf_02g.bin",   "/kd/pspbtdnf_02g.bin",
  	                             "DDC7_pspbtjnf.bin",       "/kd/pspbtjnf.bin",
  	                             "DDC7_pspbtjnf_02g.bin",   "/kd/pspbtjnf_02g.bin",
  	                             "DDC7_pspbtknf.bin",       "/kd/pspbtknf.bin",
  	                             "DDC7_pspbtknf_02g.bin",   "/kd/pspbtknf_02g.bin",
  	                             "DDC7_pspbtlnf.bin",       "/kd/pspbtlnf.bin",
  	                             "DDC7_pspbtlnf_02g.bin",   "/kd/pspbtlnf_02g.bin",
  	                             "DDC6_pspdecrypt.prx",     "/kd/pspdecrypt.prx",
  	                             "DDC6_recovery.prx",       "/vsh/module/recovery.prx",
  	                             "DDC7_resurrection.prx",   "/kd/resurrection.prx",
  	                             ...
  	                             "DDC7_tmctrl401.prx",      "/tmctrl401.prx",
  	                             "DDC6_usbdevice.prx",      "/kd/usbdevice.prx",
  	                             "DDC7_vlf.prx",            "/vsh/module/vlf.prx",
  	                             "DDC6_vshctrl.prx",        "/kd/vshctrl.prx",
  	                             "DDC6_system.ireg",        "/registry/system.ireg",
  	                             "DDC6_system.dreg",        "/registry/system.dreg",
  	                             "DDC7_idsregeneration.prx","/kd/idsregeneration.prx",
  	                             "DDC7_lflash_fdisk.prx",   "/kd/lflash_fdisk.prx",
                                 "0" };
  ...
  {
    l = hcMiscSeqGetFile( dataPSAR, r, AdditionalDDCFiles[i], dataOut );
    sprintf( s, "ms0:/TM/DC7%s", AdditionalDDCFiles[i+1] );
    WriteFile( s, dataOut, l );
    i += 2;
    if( strcmp( AdditionalDDCFiles[i], "0" ) == 0 ) { break; }
  }
  ...
  l = mainReadFile( "ms0:/TM/DC7/sceNandIpl_1k.bin", dataOut + 0x3000, 2000000 );
  i = hcMiscSeqGetFile( dataPSAR, r, "DDC7_cpl1000.bin", dataOut );
  WriteFile( "ms0:/TM/DC7/ipl_01g.bin", dataOut, l + 0x3000 );
  l = mainReadFile( "ms0:/TM/DC7/sceNandIpl_2k.bin", dataOut + 0x3000, 2000000 );
  i = hcMiscSeqGetFile( dataPSAR, r, "DDC7_cpl2000.bin", dataOut );
  WriteFile( "ms0:/TM/DC7/ipl_02g.bin", dataOut, l + 0x3000 );
  sceIoRemove( "ms0:/TM/DC7/sceNandIpl_1k.bin" );
  sceIoRemove( "ms0:/TM/DC7/sceNandIpl_2k.bin" );
  printf( "DONE\n" );
