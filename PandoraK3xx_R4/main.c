...
void ClearScreen(void)
{
  ...
  pspDebugScreenClear();
  printf("*** Pandora Installer for 3.xx+ Kernels ***   -- Rev4 --\n");
  printf("*******************************************\n\n");
...
int main(int argc, char *argv[])
{
  ...
  hcMiscMenuAddEntry( "Install a DDC MagicStick (for Fat + Slim)", 41, "   This option sets up a complete DDC (DAX' universal unbricker)\n   MagicStick that will work for the Fat and Slim PSPs and will\n   flash a M33 CFW to your PSP.");
  hcMiscMenuAddEntry( "Install ELF-Menu and NAND-Tool to the DDC stick", 42, "   This requires a set up DDC stick and will add jas0nuk's ELF-Menu\n   and cory's NAND-Tool to it!\n   For best PSP maintanance :-)" );
