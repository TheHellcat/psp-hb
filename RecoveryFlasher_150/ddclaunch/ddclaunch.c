...
PSP_MODULE_INFO("HCRF_DDCLauncherHelper", 0x800, 1, 0);
//PSP_MODULE_INFO("HCRF_DDCLauncherHelper", 0x00, 1, 0);
...
int main(int argc, char *argv[])
{
  ...
  r = pspSdkLoadStartModule("flash0:/kd/ddc_plain.prx", PSP_MEMORY_PARTITION_USER);
      
  // we don't leave ppl behind.... that goes for tempfiles as well :-p
  if( nc != 1 )
  {
    sceIoRemove( "ms0:/TM/DC7/kd/ddc_plain.prx" );
